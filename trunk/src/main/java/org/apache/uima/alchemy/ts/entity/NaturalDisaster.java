...
public class NaturalDisaster extends TOP {
  ...
  public StringArray getQuotations() {
    if (NaturalDisaster_Type.featOkTst && ((NaturalDisaster_Type)jcasType).casFeat_quotations == null)
      jcasType.jcas.throwFeatMissing("quotations", "org.apache.uima.alchemy.ts.entity.NaturalDisaster");
    return (StringArray)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((NaturalDisaster_Type)jcasType).casFeatCode_quotations)));}
  ...
  public void setQuotations(StringArray v) {
    if (NaturalDisaster_Type.featOkTst && ((NaturalDisaster_Type)jcasType).casFeat_quotations == null)
      jcasType.jcas.throwFeatMissing("quotations", "org.apache.uima.alchemy.ts.entity.NaturalDisaster");
    jcasType.ll_cas.ll_setRefValue(addr, ((NaturalDisaster_Type)jcasType).casFeatCode_quotations, jcasType.ll_cas.ll_getFSRef(v));}    
  ...
  public String getQuotations(int i) {
    if (NaturalDisaster_Type.featOkTst && ((NaturalDisaster_Type)jcasType).casFeat_quotations == null)
      jcasType.jcas.throwFeatMissing("quotations", "org.apache.uima.alchemy.ts.entity.NaturalDisaster");
    jcasType.jcas.checkArrayBounds(jcasType.ll_cas.ll_getRefValue(addr, ((NaturalDisaster_Type)jcasType).casFeatCode_quotations), i);
    return jcasType.ll_cas.ll_getStringArrayValue(jcasType.ll_cas.ll_getRefValue(addr, ((NaturalDisaster_Type)jcasType).casFeatCode_quotations), i);}
  ...
  public void setQuotations(int i, String v) { 
    if (NaturalDisaster_Type.featOkTst && ((NaturalDisaster_Type)jcasType).casFeat_quotations == null)
      jcasType.jcas.throwFeatMissing("quotations", "org.apache.uima.alchemy.ts.entity.NaturalDisaster");
    jcasType.jcas.checkArrayBounds(jcasType.ll_cas.ll_getRefValue(addr, ((NaturalDisaster_Type)jcasType).casFeatCode_quotations), i);
    jcasType.ll_cas.ll_setStringArrayValue(jcasType.ll_cas.ll_getRefValue(addr, ((NaturalDisaster_Type)jcasType).casFeatCode_quotations), i, v);}
  }
