...
/* First created by JCasGen Sat Jan 23 16:29:37 CET 2010 */
...
/** 
 * Updated by JCasGen Sat Jan 23 16:29:37 CET 2010
 * @generated */
public class MicroformatFS_Type extends TOP_Type {
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  		     ...
  		     return fs;
        } else return new MicroformatFS(addr, MicroformatFS_Type.this);
  	  }
    };
  /** @generated */
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.uima.alchemy.ts.MicroformatFS");
  ...
  public String getFieldName(int addr) {
      ...
      jcas.throwFeatMissing("fieldName", "org.apache.uima.alchemy.ts.MicroformatFS");
  ...
  public String getFieldData(int addr) {
      ...
      jcas.throwFeatMissing("fieldData", "org.apache.uima.alchemy.ts.MicroformatFS");
  ...
  public MicroformatFS_Type(JCas jcas, Type casType) {
    ...
    casFeat_fieldName = jcas.getRequiredFeatureDE(casType, "fieldName", "uima.cas.String", featOkTst);
    casFeatCode_fieldName  = (null == casFeat_fieldName) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_fieldName).getCode();

 
    casFeat_fieldData = jcas.getRequiredFeatureDE(casType, "fieldData", "uima.cas.String", featOkTst);
    casFeatCode_fieldData  = (null == casFeat_fieldData) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_fieldData).getCode();
