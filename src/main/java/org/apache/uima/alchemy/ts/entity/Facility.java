...
public class Facility extends TOP {
  ...
  public StringArray getQuotations() {
    ...
    return (StringArray)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((Facility_Type)jcasType).casFeatCode_quotations)));}
  ...
  public void setQuotations(StringArray v) {
    if (Facility_Type.featOkTst && ((Facility_Type)jcasType).casFeat_quotations == null)
      jcasType.jcas.throwFeatMissing("quotations", "org.apache.uima.alchemy.ts.entity.Facility");
    jcasType.ll_cas.ll_setRefValue(addr, ((Facility_Type)jcasType).casFeatCode_quotations, jcasType.ll_cas.ll_getFSRef(v));}    
  ...
  public String getQuotations(int i) {
    if (Facility_Type.featOkTst && ((Facility_Type)jcasType).casFeat_quotations == null)
      jcasType.jcas.throwFeatMissing("quotations", "org.apache.uima.alchemy.ts.entity.Facility");
    jcasType.jcas.checkArrayBounds(jcasType.ll_cas.ll_getRefValue(addr, ((Facility_Type)jcasType).casFeatCode_quotations), i);
    return jcasType.ll_cas.ll_getStringArrayValue(jcasType.ll_cas.ll_getRefValue(addr, ((Facility_Type)jcasType).casFeatCode_quotations), i);}
  ...
  public void setQuotations(int i, String v) { 
    if (Facility_Type.featOkTst && ((Facility_Type)jcasType).casFeat_quotations == null)
      jcasType.jcas.throwFeatMissing("quotations", "org.apache.uima.alchemy.ts.entity.Facility");
    jcasType.jcas.checkArrayBounds(jcasType.ll_cas.ll_getRefValue(addr, ((Facility_Type)jcasType).casFeatCode_quotations), i);
    jcasType.ll_cas.ll_setStringArrayValue(jcasType.ll_cas.ll_getRefValue(addr, ((Facility_Type)jcasType).casFeatCode_quotations), i, v);}
  }
