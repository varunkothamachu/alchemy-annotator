...
/* First created by JCasGen Thu Oct 29 09:49:07 CET 2009 */
...
public class Anniversary extends TOP {
  ...
  public String getText() {
    if (Anniversary_Type.featOkTst && ((Anniversary_Type)jcasType).casFeat_text == null)
      jcasType.jcas.throwFeatMissing("text", "org.apache.uima.alchemy.ts.Anniversary");
  ...
  public String getCount() {
    if (Anniversary_Type.featOkTst && ((Anniversary_Type)jcasType).casFeat_count == null)
      jcasType.jcas.throwFeatMissing("count", "org.apache.uima.alchemy.ts.Anniversary");
  ...
  public String getRelevance() {
    if (Anniversary_Type.featOkTst && ((Anniversary_Type)jcasType).casFeat_relevance == null)
      jcasType.jcas.throwFeatMissing("relevance", "org.apache.uima.alchemy.ts.Anniversary");
